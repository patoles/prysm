export default class Shockwave{
    ...
    init(ctx, shaderProgram, shaderParams, canvasInfo){
	...
	draw(ctx, shaderProgram, shaderParams){
		shaderParams.waveList.forEach((item, key) => {
    ...
    handleClick(event, shaderParams, canvasInfo){
	...
	handleTouchMove(event, shaderParams, canvasInfo){
    ...
    setWavePos(x, y, shaderParams, canvasInfo){
